...
required = [
    ...
    'docs/reference/SDK_ALIGNMENT.md','docs/reference/xmate6_official_alignment_manifest.json','docs/reference/RUNTIME_STATE_MACHINE.md','docs/reference/runtime_state_machine_manifest.json','docs/reference/RECORDED_PATH_SCHEMA.md','docs/reference/recorded_path_schema_manifest.json','docs/archive/audits/IMPLEMENTATION_AUDIT.md','examples/README.md']
for rel in required:
    if not (ROOT/rel).is_file():
        FAILURES.append(f'missing required docs/layout file: {rel}')
removed = [
    'docs/COMPAT_ABI.md','docs/API_ALIGNMENT_MATRIX.md','docs/XMATE6_OFFICIAL_ALIGNMENT_MATRIX.md','docs/RT_PROFILE_GUIDE.md','docs/RT_HARDENING_PROFILE.md','docs/PROFILE_CAPABILITY_MATRIX.md','docs/PROFILE_QUERY_POLICY.md','docs/RUNTIME_CATALOG_POLICY.md','docs/KINEMATICS_POLICY.md','docs/FIDELITY_POLICY.md','docs/MODEL_TRACEABILITY.md','docs/EXTENSION_FRAMEWORK.md','docs/P0_1_DEEP_REVIEW_REPORT.md','docs/P0_1_IMPLEMENTATION_SUMMARY.md','docs/P0_1_ISSUE_REMEDIATION_SUMMARY.md','docs/P0_1_SECOND_REFINEMENT_SUMMARY.md','docs/HARDENING_BACKLOG.md','docs/IMPLEMENTATION_AUDIT.md','docs/maintenance/HARDENING_BACKLOG.md','examples/PUBLIC_SDK_README.md']
for rel in removed:
    if (ROOT/rel).exists():
