#ifndef ROKAE_XMATE3_ROS2_GAZEBO_MODEL_FACADE_HPP
#define ROKAE_XMATE3_ROS2_GAZEBO_MODEL_FACADE_HPP
...
using ModelLoadContext = LoadContext;
...
#endif  // ROKAE_XMATE3_ROS2_GAZEBO_MODEL_FACADE_HPP
