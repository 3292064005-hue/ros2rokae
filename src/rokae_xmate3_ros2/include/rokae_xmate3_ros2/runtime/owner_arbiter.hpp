#ifndef ROKAE_XMATE3_ROS2_RUNTIME_OWNER_ARBITER_PUBLIC_HPP
#define ROKAE_XMATE3_ROS2_RUNTIME_OWNER_ARBITER_PUBLIC_HPP
 ...
 private:
  [[nodiscard]] TransitionResult transitionTo(ControlOwner desired_owner, const std::string &reason) {
    ...
    if (!canTransition(desired_owner)) {
      ...
      return {false, current_owner_, rejected_reason};
    }
...
#endif  // ROKAE_XMATE3_ROS2_RUNTIME_OWNER_ARBITER_PUBLIC_HPP
